...
The compact `app/backend/robot_console.py` is the PR30 commissioning service;
`app/desktop/operator.py` is the laptop operator surface. One Jetson backend streams STM32/N10P/Astra-S state to
