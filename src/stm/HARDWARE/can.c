...
void CAN1_Rx_Msg(u8 fifox,u32 *id,u8 *ide,u8 *rtr,u8 *len,u8 *dat)
{
	...
	*len=CAN1->sFIFOMailBox[fifox].RDTR&0x0F;
	dat[0]=(u8)(CAN1->sFIFOMailBox[fifox].RDLR);
	dat[1]=(u8)(CAN1->sFIFOMailBox[fifox].RDLR>>8);
	dat[2]=(u8)(CAN1->sFIFOMailBox[fifox].RDLR>>16);
	dat[3]=(u8)(CAN1->sFIFOMailBox[fifox].RDLR>>24);
	dat[4]=(u8)(CAN1->sFIFOMailBox[fifox].RDHR);
	dat[5]=(u8)(CAN1->sFIFOMailBox[fifox].RDHR>>8);
	dat[6]=(u8)(CAN1->sFIFOMailBox[fifox].RDHR>>16);
	dat[7]=(u8)(CAN1->sFIFOMailBox[fifox].RDHR>>24);
	CAN_FIFORelease(CAN1,fifox);
}
...
void CAN1_RX0_IRQHandler(void)
{
	...
	if(ide==0&&rtr==0&&CcaRuntime_OnCanFrame(id,temp_rxbuf,len))
	{
		return;
	}
